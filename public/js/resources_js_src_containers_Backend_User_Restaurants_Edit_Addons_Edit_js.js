...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch(_store_actions_backend_restaurants__WEBPACK_IMPORTED_MODULE_16__.getRestaurantsEdit('addons', id));
    },
    post: function post(data) {
      return dispatch(_store_actions_backend_restaurants__WEBPACK_IMPORTED_MODULE_16__.postRestaurantsEdit('addons', data));
    },
    patch: function patch(id, data) {
      return dispatch(_store_actions_backend_restaurants__WEBPACK_IMPORTED_MODULE_16__.patchRestaurantsEdit('addons', id, data));
    }
  };
};
