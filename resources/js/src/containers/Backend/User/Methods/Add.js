...
import { faParagraph, faPencilAlt, faThList } from '@fortawesome/free-solid-svg-icons';
...
class Add extends Component {
    ...
    render() {
                        ...
                        <div className="shadow-lg rounded-8 bg-white px-4 px-sm-5 py-3 py-sm-4">
                            <Row className="my-2 my-sm-3">
                                <div className="col-lg-9">
                                    <Row>
                                        <FormInput type="text" className="col-md-6" icon={faThList} onChange={this.inputChangeHandler} value={name} name="name" required placeholder={form.name} />
                                        <FormInput type="text" className="col-md-6" icon={faParagraph} onChange={this.inputChangeHandler} value={text} name="text" required placeholder={form.text} />
        ...
        return (
            <>
                <TitleWrapper>
                    <Breadcrumb items={this.props.edit && [{ to: '/user/methods', content: index }]} main={this.props.edit ? edit : add} icon={faThList} />
                ...
                <div>
                    ...
                    {errors}
                    <Row>
                        <Form onSubmit={this.saveHandler} icon={faThList} title={this.props.edit ? edit : add} list={index} link="/user/methods" innerClassName="row justify-content-center">
                            {content}
                        </Form>
                    </Row>
                </div>
