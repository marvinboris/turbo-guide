    ...
    render() {
        ...
        if (loading) content = <Col xs={12}>
            ...
            content = (
                <>
                    <Row>
                        <Form onSubmit={this.submitHandler} icon={faCircleNotch} title={this.props.edit ? edit : add} list={index} link="/admin/cycles" innerClassName="row" className="shadow-sm">
                            <Col lg={8}>
