...
var SubNavLinks = function SubNavLinks(_ref2) {
  ...
  var keys = Object.keys(_components_Content_Messages__WEBPACK_IMPORTED_MODULE_18__.default).filter(function (key) {
...
var Messages = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Messages, [{
    ...
    value: function render() {
      ...
      var redirect = !(feature && JSON.parse(feature.permissions).includes('u')) && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_19__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Redirect, {
        to: "/user/dashboard"
      });
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.backend.cms.cms && prevState.app_name === '') {
        ...
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_17__.updateObject)(prevState, _objectSpread({}, messages));
      }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    patch: function patch(data) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_16__.patchCms('messages', data));
    },
