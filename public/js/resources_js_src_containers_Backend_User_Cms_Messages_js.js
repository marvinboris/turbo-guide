...
/* harmony import */ var _components_Content_Messages__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../../../components/Content/Messages */ "./resources/js/src/components/Content/Messages.js");
...
var SubNavLinks = function SubNavLinks(_ref2) {
  ...
  var authItem = _components_Content_Messages__WEBPACK_IMPORTED_MODULE_19__.default.auth;
  ...
  var keys = Object.keys(_components_Content_Messages__WEBPACK_IMPORTED_MODULE_19__.default).filter(function (key) {
    return !['auth'].includes(key);
  });
  var resourceTabPanes = keys.map(function (item) {
    var currentItem = _components_Content_Messages__WEBPACK_IMPORTED_MODULE_19__.default[item];
...
var Messages = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Messages, [{
    ...
    value: function render() {
      ...
      var redirect = !(feature && JSON.parse(feature.permissions).includes('u')) && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Redirect, {
        to: "/user/dashboard"
      });
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.backend.cms.cms && prevState.app_name === '') {
        ...
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_18__.updateObject)(prevState, _objectSpread({}, messages));
      }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    patch: function patch(data) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_17__.patchCms('messages', data));
    },
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react_router_dom__WEBPACK_IMPORTED_MODULE_3__.withRouter)((0,react_redux__WEBPACK_IMPORTED_MODULE_2__.connect)(mapStateToProps, mapDispatchToProps)(Messages)));
