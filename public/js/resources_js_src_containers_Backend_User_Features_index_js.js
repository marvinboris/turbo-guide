...
var Index = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var redirect = !feature_ && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_2__.Redirect, {
        to: "/user/dashboard"
      });
      ...
      var data = features.map(function (feature) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_15__.updateObject)(feature, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_15__.convertDate)(feature.created_at),
          action: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)("div", {
            ...
            }), JSON.parse(feature_.permissions).includes('u') && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_2__.Link, {
            ...
            }), JSON.parse(feature_.permissions).includes('d') && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("span", {
              className: "mx-1",
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_14__.getFeatures(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_14__.deleteFeatures(id));
    },
