    ...
    render() {
        ...
        if (loading) content = <Col xs={12}>
            ...
            content = (
                <>
                    <Row>
                        <Form onSubmit={this.submitHandler} icon={faLayerGroup} title={this.props.edit ? edit : add} list={index} link="/user/levels" innerClassName="row" className="shadow-sm">
                            <Col lg={8}>
        ...
        return (
            <>
                <TitleWrapper>
                    <Breadcrumb items={this.props.edit && [{ to: '/user/levels', content: index }]} main={this.props.edit ? edit : add} icon={faLayerGroup} />
