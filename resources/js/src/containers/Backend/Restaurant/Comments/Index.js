...
class Index extends Component {
    ...
    render() {
        ...
        const redirect = (!plan || (plan && !plan.reviews)) && <Redirect to="/restaurant/dashboard" />
        const errors = <>
            <Error err={error} />
        </>;
...
const mapDispatchToProps = dispatch => ({
    get: (page, show, search) => dispatch(actions.getComments(page, show, search)),
    delete: id => dispatch(actions.deleteComments(id)),
    reset: () => dispatch(actions.resetComments()),
});
