...
class Meal extends Component {
    render() {
        const { id, name, photo, price, is_active, description, mark, comments, className = '' } = this.props

        return <div className={`Meal m-2 rounded-4 bg-white shadow-sm ${className}`}>
            <div>
            ...
            <div className="p-3 bg-white overflow-hidden">
                ...
                <div className="text-12 text-700 d-flex align-items-center text-truncate">
                    ...
                    <div className="text-6 text-300">XAF</div>
                </div>
            </div>
        </div>;
    }
