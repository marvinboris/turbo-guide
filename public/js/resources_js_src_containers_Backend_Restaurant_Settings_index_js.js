  ...
  _createClass(Settings, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          restaurantLanguages = _this$props$auth$data.languages;
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_17__.getSettings());
    },
    restaurant: function restaurant(data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_17__.restaurantSettings(data));
    },
    account: function account(data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_17__.accountSettings(data));
    },
    cms: function cms(data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_17__.cmsSettings(data));
    },
    translatable: function translatable(data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_17__.translatableSettings(data));
    },
    language: function language(data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_17__.languageSettings(data));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_17__.resetSettings());
    }
  };
};
