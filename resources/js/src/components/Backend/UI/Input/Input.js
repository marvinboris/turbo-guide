...
export default ({ icon, addon, onChange, className = '', id, name, type = 'text', required, readonly, placeholder, value = '', defaultValue, validation = {}, append, children }) => {
