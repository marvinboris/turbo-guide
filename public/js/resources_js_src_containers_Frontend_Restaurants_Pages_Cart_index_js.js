...
var Cart = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Cart, [{
    ...
    value: function render() {
      ...
      var due_amount = total + delivery_fee + service_charge;
      ...
      var optionsContent = Object.keys(cms.options.list).map(function (key) {
        ...
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
          className: "options".concat(option.key === _this2.state.option ? ' active' : ''),
          onClick: function onClick() {
            return _this2.selectOption(option.key);
          },
          children: [option.name, /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("i", {
