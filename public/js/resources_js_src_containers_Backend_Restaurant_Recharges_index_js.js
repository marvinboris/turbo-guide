...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_13__.getRecharges(page, show, search));
    },
    post: function post(data) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_13__.postRecharges(data));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_13__.deleteRecharges(id));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_13__.resetRecharges());
    }
  };
};
