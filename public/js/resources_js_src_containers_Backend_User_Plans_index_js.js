  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = plans.map(function (plan) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_15__.updateObject)(plan, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_15__.convertDate)(plan.created_at),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_14__.getPlans(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_14__.deletePlans(id));
    },
