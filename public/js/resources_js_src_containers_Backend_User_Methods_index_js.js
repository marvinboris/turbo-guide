  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = methods.map(function (method) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_14__.updateObject)(method, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_14__.convertDate)(method.created_at),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_13__.getMethods(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_13__.deleteMethods(id));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_13__.resetMethods());
    }
  };
};
