...
/* harmony import */ var _Meals_css__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./Meals.css */ "./resources/js/src/containers/Backend/User/Restaurants/Edit/Meals/Meals.css");
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch(_store_actions_backend_restaurants__WEBPACK_IMPORTED_MODULE_16__.getRestaurantsEdit('meals', id));
    },
    info: function info() {
      return dispatch(_store_actions_backend_restaurants__WEBPACK_IMPORTED_MODULE_16__.infoRestaurantsEdit('meals'));
    },
    post: function post(data) {
      return dispatch(_store_actions_backend_restaurants__WEBPACK_IMPORTED_MODULE_16__.postRestaurantsEdit('meals', data));
    },
    patch: function patch(id, data) {
      return dispatch(_store_actions_backend_restaurants__WEBPACK_IMPORTED_MODULE_16__.patchRestaurantsEdit('meals', id, data));
    }
  };
};
