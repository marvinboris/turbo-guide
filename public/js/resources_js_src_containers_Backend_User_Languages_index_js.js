  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = languages.map(function (language) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_15__.updateObject)(language, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_15__.convertDate)(language.created_at),
          flag: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)("div", {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_14__.getLanguages(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions_backend__WEBPACK_IMPORTED_MODULE_14__.deleteLanguages(id));
    },
