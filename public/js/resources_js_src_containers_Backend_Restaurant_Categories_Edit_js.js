  ...
  _createClass(Add, [{
    ...
    function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.backend.categories.category && prevState.name === '') {
        var category = nextProps.backend.categories.category;
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_14__.updateObject)(prevState, _objectSpread({}, category));
      }
