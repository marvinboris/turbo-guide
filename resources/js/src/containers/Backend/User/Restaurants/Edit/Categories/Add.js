...
class Add extends Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (!prevProps.backend.restaurants.category && this.props.backend.restaurants.category) {
            const { backend: { restaurants: { category } } } = this.props;
    ...
    render() {
        let {
            ...
            backend: { restaurants: { data: { languages }, loading, error, message, category } },
        } = this.props;
        ...
        return (
            <>
                <TitleWrapper>
                    <Breadcrumb items={this.props.edit && [{ to: '/user/restaurants/' + this.props.match.params.restaurant + '/edit/categories', content: index }]} main={this.props.edit ? edit : add} icon={faListAlt} />
                ...
                <div>
                    {errors}
                    <Row>
                        <Form onSubmit={this.saveHandler} icon={faListAlt} title={this.props.edit ? edit : add} subtitle={subtitle} list={index} link={"/user/restaurants/" + this.props.match.params.restaurant + '/edit/categories'} innerClassName="row justify-content-center">
...
const mapDispatchToProps = dispatch => ({
    get: id => dispatch(actions.getRestaurantsEdit('categories',id)),
    post: data => dispatch(actions.postRestaurantsEdit('categories', data)),
    patch: (id, data) => dispatch(actions.patchRestaurantsEdit('categories', id, data)),
});
