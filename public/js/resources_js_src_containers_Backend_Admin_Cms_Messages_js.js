...
/* harmony import */ var _components_Content_Messages__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../../components/Content/Messages */ "./resources/js/src/components/Content/Messages.js");
...
var SubNavLinks = function SubNavLinks(_ref2) {
  ...
  var authItem = _components_Content_Messages__WEBPACK_IMPORTED_MODULE_17__.default.auth;
  ...
  var resourceTabPanes = ['admins', 'users', 'roles', 'features', 'languages', 'notifications', 'cms', 'settings', 'cycles', 'levels', 'classrooms', 'years', 'students', 'subjects', 'sessions', 'trimesters', 'sequences', 'exam_types', 'exams', 'marks'].map(function (item) {
    var currentItem = _components_Content_Messages__WEBPACK_IMPORTED_MODULE_17__.default[item];
  ...
  _createClass(Messages, [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.backend.cms.cms && prevState.app_name === '') {
        ...
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_16__.updateObject)(prevState, _objectSpread({}, messages));
      }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    patch: function patch(data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_15__.patchCms('messages', data));
    },
