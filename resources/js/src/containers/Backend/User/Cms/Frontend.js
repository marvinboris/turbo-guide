    ...
    render() {
        ...
        if (loading) content = <Col xs={12}>
            ...
            content = (
                <>
                    <Row>
                        <Form onSubmit={this.submitHandler} icon={faWrench} title={frontend} link="/admin/cms" innerClassName="row" className="shadow-sm">
                            <Col lg={12}>
        ...
        return (
            <>
                <TitleWrapper>
                    <Breadcrumb main={frontend} icon={faWrench} />
                    <SpecialTitle user icon={faWrench}>{title}</SpecialTitle>
                    <Subtitle user>{frontend}</Subtitle>
                </TitleWrapper>
...
const mapDispatchToProps = dispatch => ({
    ...
    patch: data => dispatch(actions.patchCms('frontend', data)),
