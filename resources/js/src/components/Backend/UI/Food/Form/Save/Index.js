...
class Save extends Component {
    render() {
        ...
        return <div className="col-12">
            <Button color="orange" className="rounded-4 py-2 py-sm-3 px-3 px-sm-4">
            ...
            {!edit && <Button color="green" onClick={saveAddHandler} className="rounded-4 py-2 py-sm-3 px-3 px-sm-4 ml-2 ml-sm-3">
