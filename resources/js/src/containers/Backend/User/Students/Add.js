    ...
    render() {
        ...
        if (loading) content = <Col xs={12}>
            ...
            content = (
                <>
                    <Row>
                        <Form onSubmit={this.submitHandler} icon={faUserGraduate} title={this.props.edit ? edit : add} list={index} link="/user/students" innerClassName="row" className="shadow-sm">
                            <Col lg={8}>
