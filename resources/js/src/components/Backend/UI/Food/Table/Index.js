...
class Table extends Component {
    ...
    render() {
        const {
            fields, array, loading = false, total = 0, limit, bordered, xs = 12, sm = 12, md = 12, lg = 12, xl = 12, icon, title, subtitle, add, link, className = '', dark = false, borderless, innerClassName = '', outerClassName = '', p0, select, children, selectHandler, style,
            content: {
                cms: {
