...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions_backend_restaurants__WEBPACK_IMPORTED_MODULE_14__.getRestaurantsEdit('comments', page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions_backend_restaurants__WEBPACK_IMPORTED_MODULE_14__.deleteRestaurantsEdit('comments', id));
    }
  };
};
