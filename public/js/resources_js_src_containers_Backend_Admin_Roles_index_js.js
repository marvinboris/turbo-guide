  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = roles.map(function (role) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_14__.updateObject)(role, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_14__.convertDate)(role.created_at),
